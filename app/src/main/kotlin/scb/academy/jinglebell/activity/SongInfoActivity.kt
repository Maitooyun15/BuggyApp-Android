...
class SongInfoActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun startActivity(context: Context?, song: Song? = null) =
            context?.startActivity(Intent(context, SongInfoActivity::class.java).also { intent ->
                intent.putExtra(EXTRA_SONG, song)
                intent.putExtra(DATE_FORMAT_DATE_ONLY ,song)
                intent.putExtra(DATE_FORMAT_ISO_8601, song)
            })
    }
